...
DISCORD_SKU_SOCIO_VCT_ID = int(_cargar_variable_env("DISCORD_SKU_SOCIO_VCT_ID", "0") or "0")
DISCORD_APPLICATION_ID = int(_cargar_variable_env("DISCORD_APPLICATION_ID", "0") or "0")
